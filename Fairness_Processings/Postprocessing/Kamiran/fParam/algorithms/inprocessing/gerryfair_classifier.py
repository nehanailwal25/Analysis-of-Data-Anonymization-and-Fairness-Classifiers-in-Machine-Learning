...
import copy
from fParam.algorithms.inprocessing.gerryfair import heatmap
from fParam.algorithms.inprocessing.gerryfair.clean import array_to_tuple
from fParam.algorithms.inprocessing.gerryfair.learner import Learner
from fParam.algorithms.inprocessing.gerryfair.auditor import *
from fParam.algorithms.inprocessing.gerryfair.classifier_history import ClassifierHistory
...
class GerryFairClassifier(Transformer):
    ...
    def pareto(self, dataset, gamma_list):
        """Assumes Model has FP specified for metric. Trains for each value ofgamma, returns error, FP (via training), and FN (via auditing) values"""
